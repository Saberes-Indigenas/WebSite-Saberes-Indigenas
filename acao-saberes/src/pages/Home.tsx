  ...
  return (
    <>
      ...
      <section className="bg-white py-12">
        ...
        <div className="w-full flex flex-col items-center justify-center bg-red-base px-4 py-12">
          <section className="bg-white py-16 rounded-3xl">
            <div className="max-w-6xl mx-auto px-4 py-16">
              <RoundedImageTextBlock title="Games" imgSrc={Logo} alt="Game">
                O projeto apresenta um jogo digital interativo voltado à
                valorização das culturas indígenas brasileiras. Pensado como uma
                ferramenta lúdica e educativa, o jogo convida o jogador a
                percorrer territórios inspirados em diferentes povos
                originários, explorando seus costumes, línguas, mitos, rituais e
                modos de vida. Cada fase do jogo representa um bioma e um povo
                específico, estimulando a curiosidade, o respeito e o
                conhecimento sobre os saberes ancestrais.
